...
class textEditorGUI{
    ...
    //Menu items
    private JMenuItem itemOpen, itemSave, itemPrint, itemClose;
    ...
    private JMenuBar createMenuBar(){
        //  set up a menu bar component for user to access
    ...
    private class MenuItemListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(item == itemOpen){
                ...
                jText.setText("Action Listener works.");
            }
            else if(item == itemSave){
                //Save the content in text area to file
                tfc.saveFile(jText.getText());
            }
